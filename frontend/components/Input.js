...
export default function Input() {
  ...
  const style = {
    fontSize: '1.5em',
    marginBottom: '0.3em',
    color: imputValue.length > 10 ? 'crimson' : 'royalblue'
    /* STEP 2 */
  };
  ...
  return (
    <div className='widget-input container'>
      <h2>Input</h2>
      <div id='output' style={style}>{imputValue.toUpperCase()}</div>
      {/* STEP 3 */}
      <div>
        <input value={imputValue} id='imput' type='text' onChange={changeInput} />
        {/* STEP 6 */}
